...
$l.Text = "Welcome"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(30,30,60); $l.Location = New-Object System.Drawing.Point(24,16)
$l.Size = New-Object System.Drawing.Size(520,32); $pg1.Controls.Add($l)

$l = New-Object System.Windows.Forms.Label
$l.Text = "This wizard will install Teacher Dashboard on your computer.`r`n`r`nTeacher Dashboard is a private daily task planner that runs in your web browser — no accounts, no servers, and no internet required for day-to-day use."
$l.Font = New-Object System.Drawing.Font("Segoe UI", 10); $l.Location = New-Object System.Drawing.Point(24,58)
$l.Size = New-Object System.Drawing.Size(525,76); $pg1.Controls.Add($l)
...
foreach ($f in $features) {
    $lf = New-Object System.Windows.Forms.Label; $lf.Text = $f
    $lf.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $lf.ForeColor = [System.Drawing.Color]::FromArgb(55,55,90)
    $lf.Location = New-Object System.Drawing.Point(24,$fy); $lf.Size = New-Object System.Drawing.Size(525,24)
    $pg1.Controls.Add($lf); $fy += 26
}
...
$l.Location = New-Object System.Drawing.Point(24,282); $l.Size = New-Object System.Drawing.Size(525,20)
$pg1.Controls.Add($l)
...
$l = New-Object System.Windows.Forms.Label
$l.Text = "Install Location"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(30,30,60); $l.Location = New-Object System.Drawing.Point(24,16)
$l.Size = New-Object System.Drawing.Size(525,32); $pg2.Controls.Add($l)

$l = New-Object System.Windows.Forms.Label
$l.Text = "Where would you like Teacher Dashboard to be installed?"
$l.Font = New-Object System.Drawing.Font("Segoe UI", 10); $l.Location = New-Object System.Drawing.Point(24,58)
$l.Size = New-Object System.Drawing.Size(525,22); $pg2.Controls.Add($l)
...
$l.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Italic)
$l.ForeColor = [System.Drawing.Color]::FromArgb(130,130,160)
$l.Location = New-Object System.Drawing.Point(24,120); $l.Size = New-Object System.Drawing.Size(525,20)
$pg2.Controls.Add($l)

# Files-to-install info box
...
$l = New-Object System.Windows.Forms.Label
$l.Text = "Files that will be installed:"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold)
$l.Location = New-Object System.Drawing.Point(12,10); $l.Size = New-Object System.Drawing.Size(500,18)
$infoBox.Controls.Add($l)

$l = New-Object System.Windows.Forms.Label
$l.Text = "  index.html           — the dashboard application`r`n  data\dashboard.json  — your saved tasks (starts empty)`r`n  README.md            — quick-start guide`r`n  INSTALL.txt          — tips for daily use`r`n  Uninstall.bat        — remove the dashboard later"
$l.Font = New-Object System.Drawing.Font("Consolas", 8.5)
$l.ForeColor = [System.Drawing.Color]::FromArgb(60,60,100)
$l.Location = New-Object System.Drawing.Point(12,32); $l.Size = New-Object System.Drawing.Size(508,100)
$infoBox.Controls.Add($l)
...
$l = New-Object System.Windows.Forms.Label
$l.Text = "Options"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(30,30,60); $l.Location = New-Object System.Drawing.Point(24,16)
$l.Size = New-Object System.Drawing.Size(525,32); $pg3.Controls.Add($l)

# Section: Shortcuts
$l = New-Object System.Windows.Forms.Label
$l.Text = "SHORTCUTS"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 8, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(110,110,160)
$l.Location = New-Object System.Drawing.Point(24,60); $l.Size = New-Object System.Drawing.Size(525,18)
$pg3.Controls.Add($l)
...
$cbStartMenu.Text    = "Add to the Start Menu  (also adds Uninstall entry)"
...
$div1.BorderStyle = 'Fixed3D'; $div1.AutoSize = $false; $div1.Height = 1
$div1.Location    = New-Object System.Drawing.Point(24,144); $div1.Size = New-Object System.Drawing.Size(525,1)
$pg3.Controls.Add($div1)

# Section: Startup
$l = New-Object System.Windows.Forms.Label
$l.Text = "AT WINDOWS SIGN-IN"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 8, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(110,110,160)
$l.Location = New-Object System.Drawing.Point(24,156); $l.Size = New-Object System.Drawing.Size(525,18)
$pg3.Controls.Add($l)
...
$div2.BorderStyle = 'Fixed3D'; $div2.AutoSize = $false; $div2.Height = 1
$div2.Location    = New-Object System.Drawing.Point(24,212); $div2.Size = New-Object System.Drawing.Size(525,1)
$pg3.Controls.Add($div2)

# Section: After install
$l = New-Object System.Windows.Forms.Label
$l.Text = "AFTER INSTALL"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 8, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(110,110,160)
$l.Location = New-Object System.Drawing.Point(24,224); $l.Size = New-Object System.Drawing.Size(525,18)
$pg3.Controls.Add($l)
...
$l = New-Object System.Windows.Forms.Label
$l.Text = "Installing..."; $l.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(30,30,60); $l.Location = New-Object System.Drawing.Point(24,16)
$l.Size = New-Object System.Drawing.Size(525,32); $pg4.Controls.Add($l)
...
$lCheck          = New-Object System.Windows.Forms.Label
$lCheck.Text     = "✔"
$lCheck.Font     = New-Object System.Drawing.Font("Segoe UI", 42, [System.Drawing.FontStyle]::Bold)
$lCheck.ForeColor = [System.Drawing.Color]::FromArgb(22,163,74)
$lCheck.Location = New-Object System.Drawing.Point(22,12)
$lCheck.Size     = New-Object System.Drawing.Size(72,70)
$pg5.Controls.Add($lCheck)

$l = New-Object System.Windows.Forms.Label
$l.Text = "Installation complete!"; $l.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold)
$l.ForeColor = [System.Drawing.Color]::FromArgb(30,30,60)
$l.Location = New-Object System.Drawing.Point(105,25); $l.Size = New-Object System.Drawing.Size(445,32)
$pg5.Controls.Add($l)
...
$l.Location = New-Object System.Drawing.Point(24,228); $l.Size = New-Object System.Drawing.Size(525,40)
$pg5.Controls.Add($l)
...
function Start-Install {
    ...
    function Log([string]$msg, [int]$pct) {
        ...
        $logLines.Add($msg)
        $tail = if ($logLines.Count -gt 9) { $logLines.GetRange($logLines.Count - 9, 9) } else { $logLines }
        $lblLog.Text = $tail -join "`r`n"
        $form.Refresh()
    ...
    try {
        ...
        if ($cbStartMenu.Checked) {
            ...
            $su.TargetPath = $uBat; $su.WorkingDirectory = $installPath
            $su.Description = 'Remove Teacher Dashboard'; $su.Save()
            $made += "Start Menu"
        }
        ...
        $summaryText  = "Installed to:`r`n   $installPath`r`n`r`n"
        $summaryText += if ($made.Count -gt 0) { "Shortcuts created:`r`n   " + ($made -join "   |   ") } else { "No shortcuts created." }
        $lblDoneSummary.Text = $summaryText
...
$btnCancel.Add_Click({
    $r = [System.Windows.Forms.MessageBox]::Show(
        "Cancel setup and exit?", "Teacher Dashboard", 'YesNo', 'Question')
